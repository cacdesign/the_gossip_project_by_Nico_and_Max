class AuthorsController < ApplicationController
  def show
	...
	puts "$" *24
	puts @user = User.new(first_name: params["user_first_name"], last_name: params["user_last_name"], email:params["user_email"], age: params["user_age"], password: params["user_password"], city: @city, description: params["user_description"])
